/* ============================================================
   TeamFlow — helpers & constants (no mock data)
   ============================================================ */

const AV_COLORS = {
  default: "linear-gradient(140deg,#855cba,#5e3d89)",
};
...
/* Map a backend todo object → frontend shape used by the UI */
function mapTodo(t) {
  const s = t.status;
...
/* Map backend pending-approvals todo → design approval item */
function mapApprovalItem(t) {
...
/* Map dashboard/today response → team hours array */
function mapTeamHours(members) {
...
/* Map dashboard/history response → bar chart data */
function mapWeek7(historyData) {
...
/* Map reports/user response → design reportDetail entry */
function mapReportDetail(data) {
